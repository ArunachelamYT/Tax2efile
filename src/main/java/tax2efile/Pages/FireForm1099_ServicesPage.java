...
public class FireForm1099_ServicesPage extends PageProperties{
	...
	public FireForm1099_ServicesPage(WebDriver Driver) { super(Driver);}
	...
	public FireForms_PayerListPage StartE_filing(String form, String taxYear) {
		...
		Select slct1 = new Select(SelectForm);
		slct1.selectByContainsVisibleText(form);
		StartFiling.click();
		
		Select slct2 = new Select(SelectTaxYear);
		slct2.selectByContainsVisibleText(taxYear);
		saveButton.click();
